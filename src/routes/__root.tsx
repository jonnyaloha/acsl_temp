...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "INHA ACSL" },
      { name: "description", content: "Aerospace Control Systems Laboratory — research in aerospace systems, guidance & control, modeling & simulation, and air traffic management." },
